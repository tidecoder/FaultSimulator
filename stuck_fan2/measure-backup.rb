...
# start the measure
class stuckFan < OpenStudio::Ruleset::ModelUserScript
  ...
  def description
    return "The measure assume the fan is stuck."
  end

  # human readable description of modeling approach
  def modeler_description
    return "Fan is stuck by modifying the stuck percentage"
  end
...
stuckFan.new.registerWithApplication
